...
export function InterestCalculator(props)  {
        return (<form className="interest-calculator"
            ...
            <div className="form-group">
                ...
                <input type="number" onChange={e => props.dispatch(setPrincipal(e.target.value))} id="principal" value={props.principal}
                    min="0" />
            </div>
            <div className="form-group">
                <label htmlFor="interest">Interest rate (%)</label>
                <input type="number" onChange={e => props.dispatch(setInterest(e.target.value))} id="interest" value={props.interest}
                    min="0" max="100" step="0.1" />
            </div>
            <div className="form-group">
                <label htmlFor="years">Years</label>
                <input type="number" onChange={e => props.dispatch(setYears(e.target.value))} id="years" value={props.years}
                    min="0" max="100" />
            </div>
            <div className="form-group">
